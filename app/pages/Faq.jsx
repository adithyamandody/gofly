  ...
  return (
    <section className="flex bg-[#F2F8FF]  ">
      ...
      <div className="w-2/3 p-8 pt-32">
        ...
        <h2 className="font-bold text-2xl md:text-3xl mb-4 pl-20 pr-80 ">
          Frequently asked questions
        </h2>
        <p className="text-semibold mb-4 pl-20 text-black text-opacity-50 pr-80">
          We offer full immigration support to United Kingdom, France and
          Estonia.
        </p>
        <div className=" pl-20">
          <button className="flex justify-center items-center gap-1 px-6 py-4 border  text-sm leading-none text-white rounded-full bg-[#0E64C9]">
            Know more
            <Image
              src={arrw}
              alt="arrow"
