...
const Imigration = () => {
  return (
    <section className="mt-[55rem] flex flex-wrap md:flex-nowrap bg-[#091F35] text-white p-8 z-20 overflow-x-hidden">
      ...
      <div className="flex flex-row-reverse px-5 ">
        <div className="flex flex-col justify-center mr-7 gap-1">
          ...
          <p className="text-white text-opacity-50 mb-6 ">
            We offer full immigration support to
            <br /> United Kingdom, France and Estonia. <br /> <br />
      ...
      <div className=" flex flex-wrap md:flex-nowrap md:gap-3 justify-center pl-15 my-20 space-x-5">
        ...
        <div className="bg-gradient-to-t from-[#25477A] to-blue-800 rounded-lg p-0.2 text-left pb-10 ">
          <Image
            src={france}
            alt="Card 1"
            className="w-246 h-287 mx-auto py-0"
          />
          <h3 className="text-lg md:text-2xl font-semibold pb-2 pl-4 pt-0.5">
            France
          </h3>
          <p className="text-sm text-opacity-50 text-white pl-4">
            We offer full immigration support to
            <br /> United Kingdom, France and Estonia. <br />
            IELTS is accepted by more government <br />
            agencies,{" "}
          </p>
        </div>
        ...
        <div className="bg-gradient-to-b from-[#355EAC] to-[#0D5DF9] rounded-lg p-0.2 text-left py-3 ">
          ...
          <h3 className="text-lg md:text-2xl font-semibold pb-2 pl-4">
            United Kingdom
          </h3>
          <p className="text-sm text-opacity-50 text-white pl-4">
            We offer full immigration support to
        ...
        <div className="bg-gradient-to-t from-[#988FFF] to-[#4D46A0] rounded-lg p-0.2 text-left">
          ...
          <p className="text-sm text-opacity-50 text-white pl-4 pb-2">
            We offer full immigration support to
            <br /> United Kingdom, France and Estonia. <br />
            IELTS is accepted by more government <br />
            agencies,{" "}
